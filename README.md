...
(1–18, VIP 1, VIP 2) and the ballroom map zooms to and highlights their table.
...
Note: tables 8 and 15 are not on the supplied floor plan, so they are not on the map yet.
